...
export default async function NewsPage() {
  ...
  return <div className="w-full"><PageBreadcrumbs items={[{ label: "News", href: "/news" }]} /><ContentPageHero eyebrow="News & advice" title="The notes worth" emphasis="keeping close." description="Practical guidance and clear IFEM updates for every stage of your UK study journey." />{articles.length > 0 ? <ArticleGrid articles={articles} /> : <EmptyArticlesState />}</div>;
}
